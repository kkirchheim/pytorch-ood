...
Trains a classifier on CIFAR-10/100, optionally with an auxiliary outlier
dataset for methods like Outlier Exposure or Energy Regularization.
Configuration is managed with Hydra; see ``configs/``.

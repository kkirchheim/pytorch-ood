...
class VOSRegLoss(nn.Module):
    ...
    For initialisation of :math `\phi` and :math `weights_energy`  see https://github.com/deeplearning-wisc/vos/blob/a449b03c7d6e120087007f506d949569c845b2ec/classification/CIFAR/train_virtual.py#L132.
